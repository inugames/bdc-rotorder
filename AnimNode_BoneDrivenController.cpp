...
FVector FAnimNode_BoneDrivenController::EulerFromQuat(const FQuat& Rotation, ERotationOrder InRotationOrder)
{
	float X = Rotation.X;
	float Y = Rotation.Y;
	float Z = Rotation.Z;
	...
	if (InRotationOrder == ERotationOrder::XYZ)
	{
	...
	else if (InRotationOrder == ERotationOrder::XZY)
	{
	...
	else if (InRotationOrder == ERotationOrder::YXZ)
	{
	...
	else if (InRotationOrder == ERotationOrder::YZX)
	{
	...
	else if (InRotationOrder == ERotationOrder::ZXY)
	{
	...
	else if (InRotationOrder == ERotationOrder::ZYX)
	{
